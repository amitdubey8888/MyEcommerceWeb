...
<div class="main_wrapper">
	...
	<!--Navbar starts here-->
	 ...
	 <div class="content_wrapper">
	      ...
	      <div id="content_area">
             ...
             <div id="product_box">	
		      <form action="cart.php" method="post" enctype="multipart/form-data">
			    <table align="center" width="700" style="background:burlywood;">
			    
				  <tr align="center" style='color:darkgreen;'>
				    <th>Remove</th>
					<th>Product(s)</th>
					<th>Quantity</th>
					<th>Total Price</th>
				  ...
				  <tr align="center">
					...
					<td style='color:forestgreen;'><?php echo $product_title; ?><br>
		  ...
		  <?php }} ?>
				  <tr>
				    <td colspan="4" align="right" style="color:blue;"><b>Sub Total: <?php echo "$".$total; ?></b></td>
					<td></td>
				  </tr>
				  <tr align="center">
				    <td colspan="2"><input type="submit" name="update_cart" value="Update Cart"/></td>
					<td><input type="submit" name="continue" value="Continue Shopping"/></td>
					<td><button><a href="checkout.php" style="text-decoration:none; color:green;">Checkout</a></button></td>
				  </tr>
			    </table>
			  </form>
			  <?php 
