...
<body bgcolor="gray">
  <form method="post" action="login.php">
   <table width="400" border="10" align="center" bgcolor="pink">
    <tr>
	    <td bgcolor="yellow" align="center" colspan="4"><h1>Admin Login Form</h1><td>
	</tr>
    <tr>
...
if(isset($_POST['login']))
{
	...
	$admin_query="select * from admins_login where user_name='$user_name' AND user_pass='$user_pass'";
