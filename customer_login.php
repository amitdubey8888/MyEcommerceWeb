      ...
      <form method="post" action="">
	     <table width="500" align="center" bgcolor="skyblue">
			...
			<tr>
			   ...
			   <td align="left"><input type="text" name="email" placeholder="Enter Your Email" required/></td>
			</tr>
			<tr>
			    <td align="right"><b>Password:</b></td>
				<td align="left"><input type="password" name="pass" placeholder="Enter Your Password" required/></td>
			</tr>
			<tr align="center">
